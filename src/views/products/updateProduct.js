// material-ui
import { Grid, Typography, Button, Divider, TextField, Container, MenuItem } from '@mui/material';
// project imports
...
const UpdateProduct = () => {
    ...
    const [productPicture, setProductPicture] = useState(state.picture ? state.picture : null);
